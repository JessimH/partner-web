<template>
  <div class="flex h-[100vh] flex-no-wrap bg-gray-200">
    ...
    <div
      class="w-64 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between hidden sm:flex"
    >
      <div>
    ...
    <div
      class="w-64 z-40 h-[100vh] absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out"
      id="mobile-nav"
    >
      <div
        id="openSideBar"
      ...
      <div
        id="closeSideBar"
        class="hidden h-10 w-10 bg-indigo-900 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white"
