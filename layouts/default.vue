<template>
  <div class="flex h-[100vh] flex-no-wrap bg-gray-200">
    <!-- Sidebar starts -->
    <!-- Remove class [ hidden ] and replace [ sm:flex ] with [ flex ] -->
    <div
      class="w-64 absolute sm:relative bg-gradient-to-br from-primary-200 to-primary-400 shadow md:h-full flex-col hidden sm:flex"
    >
      ...
      <ul class="mt-8">
        <li
          class="flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-gradient-to-br from-primary-200 to-primary-400 cursor-pointer items-center py-3 px-8"
        >
        ...
        <li
          class="flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-gradient-to-br from-primary-200 to-primary-400 cursor-pointer items-center px-8 py-3"
        >
          <div class="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="flex absolute bottom-0 items-center px-8 py-8">
    ...
    <div
      class="w-64 z-40 h-[100vh] absolute sm:relative bg-gradient-to-br from-primary-200 to-primary-400 shadow md:h-full flex-col sm:hidden transition duration-150 ease-in-out"
      id="mobile-nav"
    >
      <div
        id="openSideBar"
        class="h-10 w-10 bg-gradient-to-br from-primary-200 to-primary-400 absolute right-0 mt-4 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer"
      ...
      <div
        id="closeSideBar"
        class="hidden h-10 w-10 bg-gradient-to-br from-primary-200 to-primary-400 absolute right-0 mt-4 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white"
